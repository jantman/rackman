...
$query = "UPDATE devices SET device_status_id=".((int)$_POST['statusID'])." WHERE device_id=".((int)$_POST['device_id']).";";
$result = mysql_query($query) or die("Error in query: ".$query."\nError: ".mysql_error());

$query = "INSERT INTO devices_rack SET dr_device_id=".((int)$_POST['device_id']).",dr_rack_id=".((int)$_POST['rackID']).",dr_top_U_num=".((int)$_POST['top_U_num']).",dr_pending_status=1;";
$result = mysql_query($query) or die("Error in query: ".$query."\nError: ".mysql_error());
if($result)
{
